...
- (void)checkWithResolver:(void (^ _Nonnull)(RNPermissionStatus))resolve
  ...
  if (![CLLocationManager locationServicesEnabled] || ![RNPermissions hasBackgroundModeEnabled:@"location"]) {
...
- (void)requestWithResolver:(void (^ _Nonnull)(RNPermissionStatus))resolve
  ...
  if ((status != kCLAuthorizationStatusNotDetermined && status != kCLAuthorizationStatusAuthorizedWhenInUse) ||
      ([RNPermissions hasAlreadyBeenRequested:self] && status == kCLAuthorizationStatusAuthorizedWhenInUse)) {
